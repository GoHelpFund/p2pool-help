...
import p2pool.help.networks
extra_includes.extend('p2pool.help.networks.' + x for x in p2pool.help.networks.nets)
...
try:
    ...
    if im64:
        bundle = bundle + 2
    sys.argv[1:] = ['py2exe']
    setup(name='p2pool-help',
        version=version,
        description='Peer-to-peer Help mining pool',
        author='Forrest Voight',
        author_email='forrest@forre.st',
        url='https://github.com/gohelpfund/p2pool-help/',
        data_files=[
            ('', ['README.md']),
...
dir_name = 'p2pool_help_win' + win + '_' + version
